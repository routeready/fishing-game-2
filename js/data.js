...
const EARL_LINES = [
  "EARL: THAT'S WHERE I LOST MY WEDDING RING. AND MY SECOND ONE.",
  'EARL: FISH CAN SMELL FEAR. AND CHEAP BEER.',
  'EARL: I ONCE CAUGHT A FISH THIS BIG. THE COOLER DISAGREED.',
  "EARL: YOU'RE REELING LIKE MY AUNT RITA. SHE'S BANNED FROM 3 LAKES.",
  'EARL: SUN, BEER, NO WARRANTS. PERFECT DAY.',
  "EARL: IF THE BOAT'S A-WEAVIN', THE WARDEN COMES A-PEEVIN'.",
  'EARL: BIG ONES BITE AT DUSK. SO DO MOSQUITOES.',
  'EARL: TRUST THE WEEDS, BUDDY. FISH LOVE A SALAD BAR.',
  "EARL: I AIN'T DRUNK, I'M NAUTICALLY LOOSE.",
  'EARL: MY EX GOT THE TRUCK. I GOT THE COOLER. I WON.',
];
const EARL_OFFER = "EARL: COLD ONE, CAP'N? (Y/N)";
const EARL_WARN = [
  "EARL: BAD FEELIN'... LAW'S OUT TONIGHT.",
  'EARL: I SMELL AFTERSHAVE AND PAPERWORK. STAY SHARP.',
];
const EARL_STASH = 'EARL: STASH IT! STASH IT!!';
const EARL_NEAR = [
  'EARL: HOO BOY. I SWALLOWED MY DIP.',
  'EARL: THAT WAS CLOSER THAN MY LAST HAIRCUT.',
];
